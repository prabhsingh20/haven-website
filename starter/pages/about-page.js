export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2">
        <img src="/about-2.jpg" alt="Family that manages The Haven" />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Haven has been a cherished family-run retreat.
            Started by our grandparents, this haven has been nurtured with love
            and care, passing down through our family as a testament to our
            dedication to creating a warm, welcoming environment.
          </p>
          <p>
            Over the years, we've maintained the essence of The Haven, blending
            ...
            part of our extended family. So join us at The Haven soon, where
